...
const DEMO_CONTENT = {
    ...
    relativityStream: {
        ...
        chunks: [
            ...
            { text: 'introduced ', delay: 6 },
            { text: 'by ', delay: 5 },
            { text: 'Albert ', delay: 2 },
            { text: 'Einstein, ', delay: 5 },
            { text: 'revolutionized ', delay: 5 },
            { text: 'our ', delay: 6 },
            { text: 'understanding ', delay: 3 },
            { text: 'of ', delay: 3 },
            { text: 'physics ', delay: 5 },
            { text: 'and ', delay: 3 },
            { text: 'the ', delay: 5 },
            { text: 'universe. ', delay: 2 },
            { text: 'It ', delay: 5 },
            { text: 'consists ', delay: 3 },
            { text: 'of ', delay: 5 },
            { text: 'two ', delay: 2 },
            { text: 'main ', delay: 3 },
            { text: 'theories: ', delay: 6 },
            ...
            { text: 'Relativity.\n\n', delay: 6 },
            { text: '### ', delay: 5 },
            { text: 'Special ', delay: 4 },
            { text: 'Relativity\n', delay: 3 },
            { text: 'Published ', delay: 2 },
            { text: 'in ', delay: 2 },
            { text: '1905, ', delay: 4 },
            { text: 'Special ', delay: 3 },
            { text: 'Relativity ', delay: 5 },
            { text: 'focuses ', delay: 5 },
            { text: 'on ', delay: 2 },
            { text: 'the ', delay: 5 },
            { text: 'physics ', delay: 5 },
            { text: 'of ', delay: 4 },
            { text: 'objects ', delay: 6 },
            { text: 'moving ', delay: 3 },
            { text: 'at ', delay: 5 },
            { text: 'constant ', delay: 6 },
            { text: 'speeds, ', delay: 6 },
            { text: 'particularly ', delay: 2 },
            { text: 'near ', delay: 3 },
            { text: 'the ', delay: 2 },
            { text: 'speed ', delay: 5 },
            { text: 'of ', delay: 2 },
            ...
            { text: 'for ', delay: 5 },
            { text: 'all ', delay: 6 },
            { text: 'observers, ', delay: 3 },
            { text: 'regardless ', delay: 3 },
            { text: 'of ', delay: 2 },
            { text: 'their ', delay: 6 },
            { text: 'motion.\n', delay: 3 },
            { text: '2. ', delay: 6 },
            ...
            { text: 'to ', delay: 5 },
            { text: 'one ', delay: 3 },
            { text: 'observer ', delay: 2 },
            { text: 'may ', delay: 6 },
            { text: 'not ', delay: 5 },
            { text: 'be ', delay: 3 },
            { text: 'simultaneous ', delay: 2 },
            { text: 'to ', delay: 6 },
            { text: 'another ', delay: 6 },
            { text: 'moving ', delay: 4 },
            { text: 'observer.\n', delay: 4 },
            { text: '3. ', delay: 2 },
            { text: '**Time ', delay: 6 },
            { text: 'Dilation**: ', delay: 6 },
            { text: 'Time ', delay: 3 },
            { text: 'slows ', delay: 4 },
            { text: 'down ', delay: 4 },
            { text: 'for ', delay: 4 },
            { text: 'objects ', delay: 5 },
            { text: 'moving ', delay: 5 },
            { text: 'close ', delay: 2 },
            { text: 'to ', delay: 2 },
            { text: 'the ', delay: 3 },
            ...
            { text: 'of ', delay: 3 },
            { text: 'light ', delay: 5 },
            { text: 'relative ', delay: 2 },
            { text: 'to ', delay: 4 },
            { text: 'a ', delay: 4 },
            { text: 'stationary ', delay: 4 },
            { text: 'observer.\n', delay: 3 },
            { text: '4. ', delay: 2 },
            { text: '**Length ', delay: 6 },
            ...
            { text: 'speeds ', delay: 4 },
            { text: 'appear ', delay: 4 },
            { text: 'shorter ', delay: 4 },
            { text: 'in ', delay: 6 },
            { text: 'the ', delay: 3 },
            { text: 'direction ', delay: 6 },
            { text: 'of ', delay: 3 },
            { text: 'motion.\n', delay: 5 },
            { text: '5. ', delay: 3 },
            { text: '**Mass-Energy ', delay: 4 },
            { text: 'Equivalence**: ', delay: 6 },
            { text: 'Expressed ', delay: 5 },
            { text: 'by ', delay: 3 },
            { text: 'the ', delay: 2 },
            { text: 'famous ', delay: 5 },
            ...
            { text: 'Relativity\n', delay: 3 },
            { text: 'Published ', delay: 5 },
            { text: 'in ', delay: 2 },
            { text: '1915, ', delay: 2 },
            { text: 'General ', delay: 5 },
            { text: 'Relativity ', delay: 4 },
            { text: 'extends ', delay: 6 },
            { text: 'the ', delay: 2 },
            { text: 'principles ', delay: 4 },
            { text: 'of ', delay: 2 },
            { text: 'Special ', delay: 3 },
            { text: 'Relativity ', delay: 6 },
            { text: 'to ', delay: 6 },
            { text: 'include ', delay: 4 },
            { text: 'gravity ', delay: 6 },
            { text: 'and ', delay: 3 },
            { text: 'acceleration. ', delay: 5 },
            { text: 'Its ', delay: 6 },
            { text: 'key ', delay: 5 },
            { text: 'ideas ', delay: 2 },
            { text: 'include:\n', delay: 6 },
            { text: '1. ', delay: 4 },
            { text: '**Gravity ', delay: 5 },
            { text: 'as ', delay: 5 },
            { text: 'Curved ', delay: 6 },
            { text: 'Spacetime**: ', delay: 3 },
            { text: 'Massive ', delay: 2 },
            { text: 'objects ', delay: 2 },
            { text: 'like ', delay: 2 },
            { text: 'planets ', delay: 5 },
            { text: 'and ', delay: 6 },
            { text: 'stars ', delay: 6 },
            { text: 'warp ', delay: 5 },
            { text: 'the ', delay: 5 },
            { text: 'fabric ', delay: 6 },
            { text: 'of ', delay: 6 },
            { text: 'spacetime, ', delay: 6 },
            { text: 'creating ', delay: 2 },
            { text: 'what ', delay: 5 },
            { text: 'we ', delay: 5 },
            { text: 'perceive ', delay: 4 },
            { text: 'as ', delay: 2 },
            { text: 'gravity.\n', delay: 6 },
            { text: '2. ', delay: 3 },
            { text: '**Gravitational ', delay: 2 },
            { text: 'Time ', delay: 6 },
            ...
            { text: 'slower ', delay: 2 },
            { text: 'in ', delay: 3 },
            { text: 'stronger ', delay: 6 },
            { text: 'gravitational ', delay: 4 },
            { text: 'fields.\n', delay: 5 },
            { text: '3. ', delay: 6 },
            { text: '**The ', delay: 3 },
            { text: 'Equivalence ', delay: 6 },
            { text: 'Principle**: ', delay: 2 },
            { text: 'The ', delay: 5 },
            { text: 'effects ', delay: 6 },
            { text: 'of ', delay: 5 },
            { text: 'gravity ', delay: 3 },
            { text: 'are ', delay: 5 },
            { text: 'indistinguishable ', delay: 6 },
            { text: 'from ', delay: 2 },
            { text: 'acceleration.\n', delay: 4 },
            { text: '4. ', delay: 6 },
            { text: '**Predictions**: ', delay: 3 },
            { text: 'General ', delay: 3 },
            { text: 'Relativity ', delay: 4 },
            { text: 'predicts ', delay: 6 },
            { text: 'phenomena ', delay: 5 },
            { text: 'like ', delay: 4 },
            { text: 'black ', delay: 2 },
            { text: 'holes, ', delay: 6 },
            ...
            { text: 'lensing).\n\n', delay: 6 },
            { text: 'These ', delay: 4 },
            { text: 'theories ', delay: 2 },
            { text: 'have ', delay: 6 },
            { text: 'been ', delay: 2 },
            { text: 'confirmed ', delay: 4 },
            { text: 'through ', delay: 3 },
            { text: 'experiments ', delay: 6 },
            { text: 'and ', delay: 6 },
            ...
            { text: 'relying ', delay: 2 },
            { text: 'on ', delay: 2 },
            { text: 'time ', delay: 6 },
            { text: 'dilation ', delay: 2 },
            { text: 'corrections ', delay: 2 },
            { text: 'and ', delay: 2 },
            { text: 'the ', delay: 6 },
            { text: 'detection ', delay: 4 },
            { text: 'of ', delay: 2 },
            { text: 'gravitational ', delay: 2 },
            { text: 'waves. ', delay: 3 },
            { text: 'Relativity ', delay: 5 },
            { text: 'has ', delay: 6 },
            { text: 'profoundly ', delay: 5 },
            { text: 'impacted ', delay: 3 },
            { text: 'science, ', delay: 5 },
            { text: 'technology, ', delay: 2 },
            { text: 'and ', delay: 4 },
            { text: 'our ', delay: 6 },
            { text: 'understanding ', delay: 4 },
            { text: 'of ', delay: 4 },
            { text: 'the ', delay: 4 },
            { text: 'cosmos.', delay: 6 },
        ],
...
{ text: 'The Salinas Valley is in Northern California. It is a long narrow swale between two ', delay: 0 },
            ...
            { text: 'falls at last into Monterey Bay.\n\nI remember my childhood names for grasses and secret ', delay: 22 },
            { text: 'flowers. I remember where a toad may live and what time the birds awaken in ', delay: 22 },
            { text: 'the summer—and what trees and seasons smelled like—how people looked and walked and smelled even. ', delay: 78 },
            { text: 'The memory of odors is very rich.\n\nI remember that the Gabilan Mountains to the ', delay: 22 },
            { text: 'east of the valley were light gay mountains full of sun and loveliness and a ', delay: 32 },
            { text: 'kind of invitation, so that you wanted to climb into their warm foothills almost as ', delay: 61 },
            { text: 'you want to climb into the lap of a beloved mother. They were beckoning mountains ', delay: 22 },
            { text: 'with a brown grass love. The Santa Lucias stood up against the sky to the ', delay: 76 },
            { text: 'west and kept the valley from the open sea, and they were dark and brooding—unfriendly ', delay: 93 },
            { text: 'and dangerous. I always found in myself a dread of west and a love of ', delay: 101 },
            { text: 'east. Where I ever got such an idea I cannot say, unless it could be ', delay: 22 },
            { text: 'that the morning came over the peaks of the Gabilans and the night drifted back ', delay: 21 },
            { text: 'from the ridges of the Santa Lucias. It may be that the birth and death ', delay: 59 },
            { text: 'of the day had some part in my feeling about the two ranges of mountains.\n\n', delay: 21 },
            { text: 'From both sides of the valley little streams slipped out of the hill canyons and ', delay: 23 },
            { text: 'fell into the bed of the Salinas River. In the winter of wet years the ', delay: 57 },
            { text: 'streams ran full-freshet, and they swelled the river until sometimes it raged and boiled, bank ', delay: 22 },
            { text: 'full, and then it was a destroyer. The river tore the edges of the farm ', delay: 104 },
            { text: 'lands and washed whole acres down; it toppled barns and houses into itself, to go ', delay: 21 },
            { text: 'floating and bobbing away. It trapped cows and pigs and sheep and drowned them in ', delay: 100 },
            { text: 'its muddy brown water and earned them to the sea. Then when the late spring ', delay: 49 },
            { text: 'came, the river drew in from its edges and the sand banks appeared. And in ', delay: 50 },
            { text: "the summer the river didn't run at all above ground. Some pools would be left ", delay: 59 },
            { text: 'in the deep swirl places under a high bank. The tules and grasses grew back, ', delay: 69 },
            { text: 'and willows straightened up with the flood debris in their upper branches. The Salinas was ', delay: 51 },
            { text: 'only a part-time river. The summer sun drove it underground. It was not a fine ', delay: 55 },
            { text: 'river at all, but it was the only one we had and so we boasted ', delay: 48 },
            { text: 'about it—how dangerous it was in a wet winter and how dry it was in ', delay: 49 },
            { text: "a dry summer. You can boast about anything if it's all you have. Maybe the ", delay: 51 },
            { text: 'less you have, the more you are required to boast.\n\nThe floor of the Salinas ', delay: 48 },
            { text: 'Valley, between the ranges and below the foothills, is level because this valley used to ', delay: 50 },
            { text: 'be the bottom of a hundred-mile inlet from the sea. The river mouth at Moss ', delay: 49 },
            { text: 'Landing was centuries ago the entrance to this long inland water. Once, fifty miles down ', delay: 49 },
            { text: 'the valley, my father bored a well. The drill came up first with topsoil and ', delay: 49 },
            { text: 'then with gravel and then with white sea sand full of shells and even pieces ', delay: 50 },
            { text: 'of whalebone. There were twenty feet of sand and then black earth again, and even ', delay: 48 },
            { text: 'a piece of redwood, that imperishable wood that does not rot. Before the inland sea ', delay: 48 },
            { text: 'the valley must have been a forest. And those things had happened right under our ', delay: 48 },
            { text: 'feet. And it seemed to me sometimes at night that I could feel both the ', delay: 50 },
            { text: 'sea and the redwood forest before it.\n\nOn the wide level acres of the valley ', delay: 48 },
            { text: 'the topsoil lay deep and fertile. It required only a rich winter of rain to ', delay: 50 },
            { text: 'make it break forth in grass and flowers. The spring flowers in a wet year ', delay: 49 },
            { text: 'were unbelievable. The whole valley floor, and the foothills too, would be carpeted with lupins ', delay: 49 },
            { text: 'and poppies. Once a woman told me that colored flowers would seem more bright if ', delay: 48 },
            { text: 'you added a few white flowers to give the colors definition. Every petal of blue ', delay: 51 },
            { text: 'lupin is edged with white, so that a field of lupins is more blue than ', delay: 47 },
            { text: 'you can imagine. And mixed with these were splashes of California poppies. These too are ', delay: 49 },
            { text: 'of a burning color—not orange, not gold, but if pure gold were liquid and could ', delay: 55 },
            { text: 'raise a cream, that golden cream might be like the color of the poppies. When ', delay: 35 },
            { text: 'their season was over the yellow mustard came up and grew to a great height. ', delay: 23 },
            { text: 'When my grandfather came into the valley the mustard was so tall that a man ', delay: 23 },
            { text: 'on horseback showed only his head above the yellow flowers. On the uplands the grass ', delay: 25 },
            { text: 'would be strewn with buttercups, with hen-and-chickens, with black-centered yellow violets. And a little later ', delay: 20 },
            { text: 'in the season there would be red and yellow stands of Indian paintbrush. These were ', delay: 23 },
            { text: 'the flowers of the open places exposed to the sun.\n\nUnder the live oaks, shaded ', delay: 22 },
            { text: 'and dusky, the maidenhair flourished and gave a good smell, and under the mossy banks ', delay: 41 },
            { text: 'of the water courses whole clumps of five-fingered ferns and goldy-backs hung down. Then there ', delay: 86 },
            { text: 'were harebells, tiny lanterns, cream white and almost sinful looking, and these were so rare ', delay: 24 },
            { text: 'and magical that a child, finding one, felt singled out and special all day long.\n\n', delay: 78 },
            { text: 'When June came the grasses headed out and turned brown, and the hills turned a ', delay: 28 },
            { text: 'brown which was not brown but a gold and saffron and red—an indescribable color. And ', delay: 72 },
            { text: 'from then on until the next rains the earth dried and the streams stopped. Cracks ', delay: 21 },
            { text: 'appeared on the level ground. The Salinas River sank under its sand. The wind blew ', delay: 77 },
            { text: 'down the valley, picking up dust and straws, and grew stronger and harsher as it ', delay: 22 },
            { text: 'went south. It stopped in the evening. It was a rasping nervous wind, and the ', delay: 21 },
            { text: "dust particles cut into a man's skin and burned his eyes. Men working in the ", delay: 77 },
            { text: 'fields wore goggles and tied handkerchiefs around their noses to keep the dirt out.\n\nThe ', delay: 21 },
            { text: 'valley land was deep and rich, but the foothills wore only a skin of topsoil ', delay: 79 },
            { text: 'no deeper than the grass roots; and the farther up the hills you went, the ', delay: 21 },
            { text: 'thinner grew the soil, with flints sticking through, until at the brush line it was ', delay: 77 },
            { text: 'a kind of dry flinty gravel that reflected the hot sun blindingly.\n\nI have spoken ', delay: 21 },
            { text: 'of the rich years when the rainfall was plentiful. But there were dry years too, ', delay: 78 },
            { text: 'and they put a terror on the valley. The water came in a thirty-year cycle. ', delay: 26 },
            { text: 'There would be five or six wet and wonderful years when there might be nineteen ', delay: 85 },
            { text: 'to twenty-five inches of rain, and the land would shout with grass. Then would come ', delay: 21 },
            { text: 'six or seven pretty good years of twelve to sixteen inches of rain. And then ', delay: 631 },
            { text: 'the dry years would come, and sometimes there would be only seven or eight inches ', delay: 35 },
            { text: 'of rain. The land dried up and the grasses headed out miserably a few inches ', delay: 61 },
            { text: 'high and great bare scabby places appeared in the valley. The live oaks got a ', delay: 22 },
            { text: 'crusty look and the sagebrush was gray. The land cracked and the springs dried up ', delay: 95 },
            { text: 'and the cattle listlessly nibbled dry twigs. Then the farmers and the ranchers would be ', delay: 21 },
            { text: 'filled with disgust for the Salinas Valley. The cows would grow thin and sometimes starve ', delay: 70 },
            { text: 'to death. People would have to haul water in barrels to their farms just for ', delay: 21 },
            { text: 'drinking. Some families would sell out for nearly nothing and move away. And it never ', delay: 21 },
            { text: 'failed that during the dry years the people forgot about the rich years, and during ', delay: 22 },
            { text: 'the wet years they lost all memory of the dry years. It was always that ', delay: 20 },
            { text: 'way.', delay: 1118 },
        ],
        isMarkdown: false,
        hasRealTiming: true
    ...
    apolloProgram: {
        title: "🚀 Apollo Program - Markdown CWC SSE Timing",
        chunks: [
            { text: '# The Apollo Program\n\n', delay: 0 },
            { text: 'The Apollo program was the third United States human spaceflight program carried out by NASA, which ', delay: 241 },
            { text: 'succeeded in preparing and landing the first humans on the Moon from 1968 to 1972. It ', delay: 22 },
            { text: 'was first conceived in 1960 during President Dwight D. Eisenhower\'s administration as a three-person ', delay: 75 },
            { text: 'spacecraft to follow the one-person Project Mercury, which put the first Americans in space.\n\n', delay: 25 },
            { text: '## Early Missions\n\n', delay: 95 },
            { text: 'Apollo was later dedicated to President John F. Kennedy\'s national goal of **"landing a man ', delay: 30 },
            { text: 'on the Moon and returning him safely to the Earth"** by the end of the 1960s, ', delay: 60 },
            { text: 'which he proposed in an address to Congress on May 25, 1961. It was the ', delay: 22 },
            { text: 'third US human spaceflight program to fly, preceded by the two-person Project Gemini conceived in ', delay: 80 },
            { text: '1961 to extend spaceflight capability in support of Apollo.\n\n', delay: 90 },
            { text: '### Key Achievements\n\n', delay: 100 },
            { text: 'The program achieved its goal with the successful Apollo 11 mission in July 1969, when ', delay: 22 },
            { text: 'astronauts **Neil Armstrong** and **Buzz Aldrin** landed on the Moon while Michael Collins remained in ', delay: 55 },
            { text: 'lunar orbit. Five subsequent Apollo missions also landed astronauts on the Moon, the last in ', delay: 60 },
            { text: 'December 1972. In these six spaceflights, twelve men walked on the Moon.\n\n', delay: 70 },
            { text: 'The Apollo program had several major achievements:\n\n', delay: 50 },
            { text: '- **First manned flight** - Apollo 7 (October 1968)\n', delay: 55 },
            { text: '- **First lunar orbit** - Apollo 8 (December 1968)\n', delay: 45 },
            { text: '- **First Moon landing** - Apollo 11 (July 20, 1969)\n', delay: 50 },
            { text: '- **First precision landing** - Apollo 12 (November 1969)\n', delay: 48 },
            { text: '- **Last Moon landing** - Apollo 17 (December 1972)\n\n', delay: 52 },
            { text: '## The Spacecraft\n\n', delay: 100 },
            { text: 'The Apollo spacecraft was composed of three parts:\n\n', delay: 45 },
            { text: '1. **Command Module (CM)** - The crew cabin where astronauts lived during the mission\n', delay: 50 },
            { text: '2. **Service Module (SM)** - Contained the main propulsion system, electrical power, and life support\n', delay: 55 },
            { text: '3. **Lunar Module (LM)** - The two-stage vehicle that landed on the Moon\n\n', delay: 60 },
            { text: 'The Command Module was the only portion of the Apollo spacecraft to return to Earth. It ', delay: 70 },
            { text: 'was cone-shaped and measured about 11 feet tall and 13 feet in diameter at its ', delay: 50 },
            { text: 'base. The interior was divided into three main areas: the forward compartment containing parachutes, the ', delay: 55 },
            { text: 'crew compartment, and the aft compartment containing propellant tanks.\n\n', delay: 48 },
            { text: '## Apollo 11: The First Landing\n\n', delay: 850 },
            { text: 'On July 20, 1969, Armstrong and Aldrin became the first humans to land on the ', delay: 35 },
            { text: 'Moon. Armstrong\'s first step onto the lunar surface and his words, _"That\'s one small step ', delay: 60 },
            { text: 'for man, one giant leap for mankind,"_ are among the most famous in history. The ', delay: 22 },
            { text: 'two astronauts spent about two and a quarter hours together outside the spacecraft, collecting lunar ', delay: 95 },
            { text: 'material to bring back to Earth.\n\n', delay: 25 },
            { text: '### Mission Highlights\n\n', delay: 80 },
            { text: 'The Eagle lunar module landed in the Sea of Tranquility at 20:17 UTC on July ', delay: 22 },
            { text: '20, 1969. Armstrong radioed: **"Houston, Tranquility Base here. The Eagle has landed."** Mission Control ', delay: 55 },
            { text: 'erupted in celebration as the tension of the landing dissipated. Armstrong opened the hatch and ', delay: 22 },
            { text: 'at 02:56 UTC on July 21, he stepped off the ladder onto the Moon\'s ', delay: 75 },
            { text: 'surface.\n\n', delay: 22 },
            { text: 'The astronauts deployed several scientific instruments including:\n\n', delay: 90 },
            { text: '- Solar Wind Composition Experiment\n', delay: 30 },
            { text: '- Seismic Experiment Package\n', delay: 25 },
            { text: '- Laser Ranging Retroreflector\n', delay: 23 },
            { text: '- American flag (ceremonial)\n\n', delay: 35 },
            { text: '## Later Missions\n\n', delay: 750 },
            { text: 'Each successive Apollo mission became more ambitious. **Apollo 13** suffered an oxygen tank explosion but ', delay: 60 },
            { text: 'the crew returned safely in what has been called _"a successful failure."_ The later Apollo ', delay: 22 },
            { text: 'missions 15, 16, and 17 were **J missions** featuring three-day stays on the lunar surface, ', delay: 85 },
            { text: 'extended scientific experiments, and the Lunar Roving Vehicle (LRV) which allowed astronauts to travel much ', delay: 55 },
            { text: 'farther from the landing site.\n\n', delay: 48 },
            { text: '### Apollo 17: The Final Mission\n\n', delay: 95 },
            { text: 'The Apollo program concluded with Apollo 17 in December 1972. Commander Eugene Cernan and Lunar ', delay: 22 },
            { text: 'Module Pilot Harrison Schmitt spent about 22 hours on the lunar surface in the Taurus-Littrow ', delay: 70 },
            { text: 'valley, while Command Module Pilot Ronald Evans orbited overhead. Cernan\'s final words on the Moon ', delay: 22 },
            { text: 'were: _"As we leave the Moon at Taurus-Littrow, we leave as we came and, ', delay: 88 },
            { text: 'God willing, as we shall return, with peace and hope for all mankind."_\n\n', delay: 22 },
            { text: '## Legacy\n\n', delay: 1000 },
            { text: 'The Apollo program returned 842 pounds of lunar rocks and soil to Earth, greatly contributing ', delay: 35 },
            { text: 'to the understanding of the Moon\'s composition and origin. The program laid the groundwork for ', delay: 60 },
            { text: 'future space exploration and demonstrated what could be achieved through focused national effort and international ', delay: 22 },
            { text: 'cooperation. The technologies developed for Apollo found applications in many other fields, from materials science ', delay: 95 },
            { text: 'to computer technology.\n\n', delay: 25 },
            { text: 'Today, the Apollo missions remain humanity\'s only trips beyond low Earth orbit and stand as ', delay: 80 },
            { text: 'a testament to what can be accomplished when we dare to reach for the stars.', delay: 950 }
        ],
        isMarkdown: true,
        hasRealTiming: true
    },
