...
const DEMO_CONTENT = {
    ...
    relativityStream: {
        ...
        chunks: [
            { text: 'The ', delay: 5 },
            { text: 'concept ', delay: 7 },
            { text: 'of ', delay: 9 },
            { text: 'relativity, ', delay: 10 },
            { text: 'introduced ', delay: 5 },
            { text: 'by ', delay: 8 },
            { text: 'Albert ', delay: 5 },
            { text: 'Einstein, ', delay: 9 },
            { text: 'revolutionized ', delay: 5 },
            { text: 'our ', delay: 5 },
            { text: 'understanding ', delay: 7 },
            { text: 'of ', delay: 6 },
            { text: 'physics ', delay: 9 },
            { text: 'and ', delay: 5 },
            { text: 'the ', delay: 7 },
            { text: 'universe. ', delay: 9 },
            { text: 'It ', delay: 5 },
            { text: 'consists ', delay: 7 },
            { text: 'of ', delay: 5 },
            { text: 'two ', delay: 7 },
            { text: 'main ', delay: 5 },
            { text: 'theories: ', delay: 10 },
            { text: 'Special ', delay: 5 },
            { text: 'Relativity ', delay: 8 },
            { text: 'and ', delay: 8 },
            { text: 'General ', delay: 5 },
            { text: 'Relativity.\n\n', delay: 5 },
            { text: '### ', delay: 9 },
            { text: 'Special ', delay: 8 },
            { text: 'Relativity\n', delay: 9 },
            { text: 'Published ', delay: 10 },
            { text: 'in ', delay: 5 },
            { text: '1905, ', delay: 5 },
            { text: 'Special ', delay: 8 },
            { text: 'Relativity ', delay: 9 },
            { text: 'focuses ', delay: 10 },
            { text: 'on ', delay: 10 },
            { text: 'the ', delay: 5 },
            { text: 'physics ', delay: 6 },
            { text: 'of ', delay: 9 },
            { text: 'objects ', delay: 5 },
            { text: 'moving ', delay: 9 },
            { text: 'at ', delay: 10 },
            { text: 'constant ', delay: 5 },
            { text: 'speeds, ', delay: 10 },
            { text: 'particularly ', delay: 10 },
            { text: 'near ', delay: 7 },
            { text: 'the ', delay: 9 },
            { text: 'speed ', delay: 5 },
            { text: 'of ', delay: 9 },
            ...
            { text: 'for ', delay: 6 },
            { text: 'all ', delay: 8 },
            { text: 'observers, ', delay: 5 },
            { text: 'regardless ', delay: 5 },
            { text: 'of ', delay: 9 },
            { text: 'their ', delay: 5 },
            { text: 'motion.\n', delay: 5 },
            { text: '2. ', delay: 9 },
            { text: '**Relativity ', delay: 10 },
            { text: 'of ', delay: 5 },
            { text: 'Simultaneity**: ', delay: 9 },
            { text: 'Events ', delay: 5 },
            { text: 'that ', delay: 9 },
            { text: 'appear ', delay: 5 },
            { text: 'simultaneous ', delay: 6 },
            { text: 'to ', delay: 7 },
            { text: 'one ', delay: 6 },
            { text: 'observer ', delay: 7 },
            { text: 'may ', delay: 7 },
            { text: 'not ', delay: 6 },
            { text: 'be ', delay: 5 },
            { text: 'simultaneous ', delay: 7 },
            { text: 'to ', delay: 9 },
            { text: 'another ', delay: 7 },
            { text: 'moving ', delay: 5 },
            { text: 'observer.\n', delay: 5 },
            { text: '3. ', delay: 10 },
            { text: '**Time ', delay: 8 },
            { text: 'Dilation**: ', delay: 9 },
            { text: 'Time ', delay: 6 },
            { text: 'slows ', delay: 5 },
            { text: 'down ', delay: 8 },
            { text: 'for ', delay: 7 },
            { text: 'objects ', delay: 10 },
            { text: 'moving ', delay: 7 },
            { text: 'close ', delay: 5 },
            { text: 'to ', delay: 5 },
            { text: 'the ', delay: 7 },
            ...
            { text: 'of ', delay: 5 },
            { text: 'light ', delay: 9 },
            { text: 'relative ', delay: 5 },
            { text: 'to ', delay: 5 },
            { text: 'a ', delay: 5 },
            { text: 'stationary ', delay: 5 },
            { text: 'observer.\n', delay: 5 },
            { text: '4. ', delay: 5 },
            { text: '**Length ', delay: 10 },
            { text: 'Contraction**: ', delay: 9 },
            { text: 'Objects ', delay: 9 },
            { text: 'moving ', delay: 5 },
            { text: 'at ', delay: 7 },
            { text: 'high ', delay: 5 },
            { text: 'speeds ', delay: 5 },
            { text: 'appear ', delay: 10 },
            { text: 'shorter ', delay: 5 },
            { text: 'in ', delay: 10 },
            { text: 'the ', delay: 10 },
            ...
            { text: 'motion.\n', delay: 7 },
            { text: '5. ', delay: 5 },
            { text: '**Mass-Energy ', delay: 6 },
            { text: 'Equivalence**: ', delay: 5 },
            { text: 'Expressed ', delay: 7 },
            { text: 'by ', delay: 10 },
            { text: 'the ', delay: 10 },
            { text: 'famous ', delay: 10 },
            { text: 'equation ', delay: 5 },
            { text: '\\(E ', delay: 5 },
            { text: '= ', delay: 5 },
            { text: 'mc^2\\), ', delay: 7 },
            { text: 'it ', delay: 5 },
            ...
            { text: 'General ', delay: 5 },
            { text: 'Relativity\n', delay: 8 },
            { text: 'Published ', delay: 6 },
            { text: 'in ', delay: 8 },
            { text: '1915, ', delay: 9 },
            { text: 'General ', delay: 10 },
            { text: 'Relativity ', delay: 5 },
            { text: 'extends ', delay: 9 },
            { text: 'the ', delay: 7 },
            { text: 'principles ', delay: 7 },
            { text: 'of ', delay: 5 },
            { text: 'Special ', delay: 5 },
            { text: 'Relativity ', delay: 5 },
            { text: 'to ', delay: 7 },
            { text: 'include ', delay: 8 },
            ...
            { text: 'as ', delay: 5 },
            { text: 'Curved ', delay: 5 },
            { text: 'Spacetime**: ', delay: 5 },
            { text: 'Massive ', delay: 9 },
            { text: 'objects ', delay: 5 },
            { text: 'like ', delay: 7 },
            { text: 'planets ', delay: 10 },
            { text: 'and ', delay: 10 },
            { text: 'stars ', delay: 6 },
            { text: 'warp ', delay: 6 },
            { text: 'the ', delay: 9 },
            ...
            { text: 'of ', delay: 7 },
            { text: 'spacetime, ', delay: 5 },
            { text: 'creating ', delay: 8 },
            { text: 'what ', delay: 5 },
            { text: 'we ', delay: 5 },
            { text: 'perceive ', delay: 6 },
            { text: 'as ', delay: 7 },
            { text: 'gravity.\n', delay: 5 },
            { text: '2. ', delay: 6 },
            { text: '**Gravitational ', delay: 8 },
            { text: 'Time ', delay: 8 },
            { text: 'Dilation**: ', delay: 10 },
            { text: 'Time ', delay: 6 },
            { text: 'runs ', delay: 10 },
            { text: 'slower ', delay: 5 },
            { text: 'in ', delay: 6 },
            { text: 'stronger ', delay: 10 },
            { text: 'gravitational ', delay: 8 },
            { text: 'fields.\n', delay: 8 },
            { text: '3. ', delay: 5 },
            { text: '**The ', delay: 7 },
            { text: 'Equivalence ', delay: 5 },
            { text: 'Principle**: ', delay: 9 },
            { text: 'The ', delay: 5 },
            { text: 'effects ', delay: 6 },
            { text: 'of ', delay: 10 },
            { text: 'gravity ', delay: 8 },
            { text: 'are ', delay: 5 },
            { text: 'indistinguishable ', delay: 10 },
            { text: 'from ', delay: 7 },
            { text: 'acceleration.\n', delay: 8 },
            { text: '4. ', delay: 5 },
            { text: '**Predictions**: ', delay: 10 },
            { text: 'General ', delay: 5 },
            { text: 'Relativity ', delay: 8 },
            { text: 'predicts ', delay: 5 },
            { text: 'phenomena ', delay: 9 },
            { text: 'like ', delay: 5 },
            { text: 'black ', delay: 9 },
            { text: 'holes, ', delay: 10 },
            { text: 'gravitational ', delay: 5 },
            { text: 'waves, ', delay: 7 },
            { text: 'and ', delay: 6 },
            { text: 'the ', delay: 10 },
            { text: 'bending ', delay: 8 },
            { text: 'of ', delay: 9 },
            { text: 'light ', delay: 5 },
            { text: 'by ', delay: 6 },
            { text: 'gravity ', delay: 9 },
            { text: '(gravitational ', delay: 8 },
            { text: 'lensing).\n\n', delay: 5 },
            { text: 'These ', delay: 5 },
            { text: 'theories ', delay: 5 },
            { text: 'have ', delay: 9 },
            { text: 'been ', delay: 5 },
            { text: 'confirmed ', delay: 8 },
            { text: 'through ', delay: 6 },
            { text: 'experiments ', delay: 9 },
            { text: 'and ', delay: 6 },
            { text: 'observations, ', delay: 9 },
            { text: 'such ', delay: 6 },
            { text: 'as ', delay: 9 },
            { text: 'GPS ', delay: 5 },
            { text: 'systems ', delay: 5 },
            { text: 'relying ', delay: 8 },
            { text: 'on ', delay: 6 },
            { text: 'time ', delay: 5 },
            { text: 'dilation ', delay: 8 },
            { text: 'corrections ', delay: 6 },
            { text: 'and ', delay: 9 },
            { text: 'the ', delay: 8 },
            { text: 'detection ', delay: 9 },
            { text: 'of ', delay: 10 },
            { text: 'gravitational ', delay: 7 },
            { text: 'waves. ', delay: 5 },
            { text: 'Relativity ', delay: 7 },
            { text: 'has ', delay: 9 },
            { text: 'profoundly ', delay: 5 },
            { text: 'impacted ', delay: 10 },
            { text: 'science, ', delay: 5 },
            { text: 'technology, ', delay: 8 },
            { text: 'and ', delay: 5 },
            { text: 'our ', delay: 9 },
            { text: 'understanding ', delay: 7 },
            { text: 'of ', delay: 5 },
