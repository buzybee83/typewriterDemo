...
const DEMO_CONTENT = {
    ...
    relativityStream: {
        ...
        chunks: [
            { text: 'Relativity ', delay: 0 },
            { text: 'is ', delay: 2 },
            { text: 'a ', delay: 1 },
            { text: 'cornerstone ', delay: 2 },
            { text: 'of ', delay: 1 },
            { text: 'modern ', delay: 4 },
            { text: 'physics, ', delay: 8 },
            { text: 'introduced ', delay: 2 },
            { text: 'by ', delay: 1 },
            { text: 'Albert ', delay: 2 },
            { text: 'Einstein, ', delay: 2 },
            { text: 'that ', delay: 13 },
            { text: 'fundamentally ', delay: 14 },
            { text: 'changed ', delay: 15 },
            { text: 'our ', delay: 2 },
            { text: 'understanding ', delay: 2 },
            { text: 'of ', delay: 5 },
            { text: 'space, ', delay: 25 },
            { text: 'time, ', delay: 2 },
            { text: 'and ', delay: 9 },
            ...
            { text: 'Relativity ', delay: 2 },
            { text: 'applies ', delay: 1 },
            { text: 'to ', delay: 2 },
            { text: 'objects ', delay: 1 },
            { text: 'moving ', delay: 1 },
            { text: 'at ', delay: 1 },
            ...
            { text: 'light. ', delay: 1 },
            { text: 'It ', delay: 2 },
            { text: 'introduced ', delay: 1 },
            { text: 'revolutionary ', delay: 2 },
            { text: 'ideas, ', delay: 1 },
            { text: 'such ', delay: 2 },
            { text: 'as:\n', delay: 2 },
            { text: '- ', delay: 1 },
            { text: '**Time ', delay: 2 },
            { text: 'Dilation**: ', delay: 94 },
            { text: 'Time ', delay: 1 },
            { text: 'slows ', delay: 2 },
            { text: 'down ', delay: 2 },
            { text: 'for ', delay: 1 },
            ...
            { text: 'is ', delay: 4 },
            { text: 'crucial ', delay: 69 },
            { text: 'for ', delay: 4 },
            { text: 'understanding ', delay: 3 },
            { text: 'phenomena ', delay: 3 },
            { text: 'like ', delay: 3 },
            { text: 'particle ', delay: 4 },
            { text: 'physics ', delay: 3 },
            { text: 'and ', delay: 3 },
            { text: 'the ', delay: 3 },
            { text: 'behavior ', delay: 4 },
            { text: 'of ', delay: 74 },
            { text: 'light.\n\n', delay: 4 },
            { text: '### ', delay: 3 },
            { text: 'General ', delay: 3 },
            { text: 'Relativity\n', delay: 3 },
            { text: 'Published ', delay: 4 },
            { text: 'in ', delay: 3 },
            { text: '1915, ', delay: 78 },
            { text: 'General ', delay: 4 },
            { text: 'Relativity ', delay: 2 },
            { text: 'extends ', delay: 4 },
            { text: 'the ', delay: 3 },
            ...
            { text: 'gravity ', delay: 3 },
            { text: 'and ', delay: 3 },
            { text: 'acceleration. ', delay: 4 },
            { text: 'It ', delay: 3 },
            { text: 'describes ', delay: 3 },
            { text: 'gravity ', delay: 61 },
            { text: 'not ', delay: 3 },
            { text: 'as ', delay: 3 },
            { text: 'a ', delay: 3 },
            { text: 'force ', delay: 4 },
            ...
            { text: 'objects. ', delay: 3 },
            { text: 'Key ', delay: 3 },
            { text: 'concepts ', delay: 4 },
            { text: 'include:\n', delay: 3 },
            { text: '- ', delay: 3 },
            { text: '**Gravitational ', delay: 41 },
            { text: 'Time ', delay: 3 },
            { text: 'Dilation**: ', delay: 3 },
            { text: 'Time ', delay: 4 },
            { text: 'runs ', delay: 3 },
            { text: 'slower ', delay: 98 },
            { text: 'in ', delay: 4 },
            { text: 'stronger ', delay: 2 },
            { text: 'gravitational ', delay: 3 },
            { text: 'fields.\n', delay: 3 },
            { text: '- ', delay: 4 },
            { text: '**Spacetime ', delay: 4 },
            { text: 'Curvature**: ', delay: 3 },
            { text: 'Massive ', delay: 3 },
            { text: 'objects ', delay: 3 },
            { text: 'like ', delay: 3 },
            { text: 'planets ', delay: 4 },
            { text: 'and ', delay: 3 },
            { text: 'stars ', delay: 5 },
            { text: 'bend ', delay: 3 },
            { text: 'spacetime, ', delay: 54 },
            { text: 'influencing ', delay: 3 },
            { text: 'the ', delay: 3 },
            { text: 'motion ', delay: 3 },
            { text: 'of ', delay: 3 },
            { text: 'other ', delay: 4 },
            ...
            { text: 'gravitational ', delay: 3 },
            { text: 'waves.\n\n', delay: 3 },
            { text: 'Together, ', delay: 3 },
            { text: 'these ', delay: 4 },
            { text: 'theories ', delay: 55 },
            { text: 'have ', delay: 3 },
            { text: 'reshaped ', delay: 3 },
            { text: 'our ', delay: 3 },
            { text: 'understanding ', delay: 3 },
            { text: 'of ', delay: 3 },
            { text: 'the ', delay: 4 },
            ...
            { text: 'influencing ', delay: 3 },
            { text: 'everything ', delay: 3 },
            { text: 'from ', delay: 3 },
            { text: 'GPS ', delay: 4 },
            { text: 'technology ', delay: 3 },
            { text: 'to ', delay: 3 },
            { text: 'cosmology.', delay: 38 }
        ],
        isMarkdown: true,
        hasRealTiming: true
    },
