...
const DEMO_CONTENT = {
    ...
    relativityStream: {
        ...
        chunks: [
            { text: 'The ', delay: 0 },
            { text: 'concept ', delay: 2 },
            { text: 'of ', delay: 1 },
            { text: 'relativity, ', delay: 2 },
            { text: 'introduced ', delay: 0 },
            { text: 'by ', delay: 4 },
            { text: 'Albert ', delay: 2 },
            { text: 'Einstein, ', delay: 4 },
            { text: 'revolutionized ', delay: 0 },
            { text: 'our ', delay: 2 },
            ...
            { text: 'and ', delay: 0 },
            { text: 'the ', delay: 2 },
            { text: 'universe. ', delay: 3 },
            { text: 'It ', delay: 0 },
            { text: 'consists ', delay: 1 },
            { text: 'of ', delay: 0 },
            { text: 'two ', delay: 2 },
            { text: 'main ', delay: 0 },
            { text: 'theories: ', delay: 1 },
            { text: 'Special ', delay: 0 },
            { text: 'Relativity ', delay: 2 },
            { text: 'and ', delay: 2 },
            ...
            { text: 'focuses ', delay: 2 },
            { text: 'on ', delay: 3 },
            { text: 'the ', delay: 0 },
            { text: 'physics ', delay: 1 },
            { text: 'of ', delay: 4 },
            { text: 'objects ', delay: 0 },
            { text: 'moving ', delay: 4 },
            { text: 'at ', delay: 2 },
            { text: 'constant ', delay: 0 },
            { text: 'speeds, ', delay: 4 },
            ...
            { text: 'for ', delay: 2 },
            { text: 'all ', delay: 3 },
            { text: 'observers, ', delay: 0 },
            { text: 'regardless ', delay: 0 },
            { text: 'of ', delay: 3 },
            { text: 'their ', delay: 4 },
            { text: 'motion.\n', delay: 0 },
            { text: '2. ', delay: 1 },
            ...
            { text: 'of ', delay: 1 },
            { text: 'light ', delay: 1 },
            { text: 'relative ', delay: 0 },
            { text: 'to ', delay: 1 },
            { text: 'a ', delay: 2 },
            { text: 'stationary ', delay: 0 },
            { text: 'observer.\n', delay: 1 },
            { text: '4. ', delay: 0 },
            { text: '**Length ', delay: 4 },
            { text: 'Contraction**: ', delay: 1 },
            ...
            { text: 'speeds ', delay: 0 },
            { text: 'appear ', delay: 4 },
            { text: 'shorter ', delay: 0 },
            { text: 'in ', delay: 4 },
            { text: 'the ', delay: 4 },
            { text: 'direction ', delay: 4 },
            { text: 'of ', delay: 0 },
            { text: 'motion.\n', delay: 1 },
            { text: '5. ', delay: 4 },
            { text: '**Mass-Energy ', delay: 3 },
            { text: 'Equivalence**: ', delay: 0 },
            { text: 'Expressed ', delay: 2 },
            { text: 'by ', delay: 1 },
            { text: 'the ', delay: 4 },
            { text: 'famous ', delay: 3 },
            { text: 'equation ', delay: 1 },
            { text: '\\(E ', delay: 2 },
            { text: '= ', delay: 4 },
            { text: 'mc^2\\), ', delay: 3 },
            { text: 'it ', delay: 0 },
            ...
            { text: '### ', delay: 0 },
            { text: 'General ', delay: 0 },
            { text: 'Relativity\n', delay: 3 },
            { text: 'Published ', delay: 2 },
            { text: 'in ', delay: 1 },
            { text: '1915, ', delay: 4 },
            { text: 'General ', delay: 1 },
            { text: 'Relativity ', delay: 2 },
            { text: 'extends ', delay: 2 },
            { text: 'the ', delay: 2 },
            ...
            { text: 'Relativity ', delay: 1 },
            { text: 'to ', delay: 2 },
            { text: 'include ', delay: 1 },
            { text: 'gravity ', delay: 3 },
            { text: 'and ', delay: 0 },
            { text: 'acceleration. ', delay: 0 },
            { text: 'Its ', delay: 0 },
            { text: 'key ', delay: 1 },
            { text: 'ideas ', delay: 3 },
            { text: 'include:\n', delay: 4 },
            { text: '1. ', delay: 0 },
            { text: '**Gravity ', delay: 4 },
            { text: 'as ', delay: 3 },
            { text: 'Curved ', delay: 2 },
            { text: 'Spacetime**: ', delay: 0 },
            { text: 'Massive ', delay: 3 },
            { text: 'objects ', delay: 0 },
            { text: 'like ', delay: 2 },
            { text: 'planets ', delay: 2 },
            { text: 'and ', delay: 1 },
            { text: 'stars ', delay: 3 },
            { text: 'warp ', delay: 4 },
            { text: 'the ', delay: 2 },
            ...
            { text: 'of ', delay: 4 },
            { text: 'spacetime, ', delay: 0 },
            { text: 'creating ', delay: 1 },
            { text: 'what ', delay: 0 },
            { text: 'we ', delay: 0 },
            { text: 'perceive ', delay: 2 },
            { text: 'as ', delay: 1 },
            { text: 'gravity.\n', delay: 0 },
            { text: '2. ', delay: 2 },
            { text: '**Gravitational ', delay: 1 },
            { text: 'Time ', delay: 1 },
            ...
            { text: 'The ', delay: 2 },
            { text: 'effects ', delay: 2 },
            { text: 'of ', delay: 1 },
            { text: 'gravity ', delay: 1 },
            { text: 'are ', delay: 4 },
            { text: 'indistinguishable ', delay: 2 },
            { text: 'from ', delay: 3 },
            { text: 'acceleration.\n', delay: 2 },
            { text: '4. ', delay: 0 },
            ...
            { text: 'General ', delay: 0 },
            { text: 'Relativity ', delay: 2 },
            { text: 'predicts ', delay: 0 },
            { text: 'phenomena ', delay: 4 },
            { text: 'like ', delay: 1 },
            { text: 'black ', delay: 3 },
            { text: 'holes, ', delay: 2 },
            { text: 'gravitational ', delay: 1 },
            ...
            { text: 'lensing).\n\n', delay: 0 },
            { text: 'These ', delay: 3 },
            { text: 'theories ', delay: 0 },
            { text: 'have ', delay: 4 },
            { text: 'been ', delay: 3 },
            { text: 'confirmed ', delay: 1 },
            { text: 'through ', delay: 4 },
            { text: 'experiments ', delay: 4 },
            { text: 'and ', delay: 2 },
            { text: 'observations, ', delay: 1 },
            { text: 'such ', delay: 3 },
            { text: 'as ', delay: 1 },
            { text: 'GPS ', delay: 0 },
            ...
            { text: 'on ', delay: 4 },
            { text: 'time ', delay: 4 },
            { text: 'dilation ', delay: 1 },
            { text: 'corrections ', delay: 1 },
            { text: 'and ', delay: 3 },
            { text: 'the ', delay: 4 },
            { text: 'detection ', delay: 1 },
            { text: 'of ', delay: 3 },
            { text: 'gravitational ', delay: 1 },
            { text: 'waves. ', delay: 0 },
            { text: 'Relativity ', delay: 3 },
            { text: 'has ', delay: 2 },
            { text: 'profoundly ', delay: 3 },
            { text: 'impacted ', delay: 1 },
            { text: 'science, ', delay: 0 },
            { text: 'technology, ', delay: 1 },
            { text: 'and ', delay: 0 },
            { text: 'our ', delay: 1 },
